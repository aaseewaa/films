"""
Правила автолинковки режиссёров в тексте статей.

Канонический источник для бэкенда и скриптов. Фронт: front/src/lib/articleLinkRules.ts
(дублирует данные — при правках синхронизировать вручную).
"""
